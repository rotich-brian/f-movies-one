...
const Header: React.FC = () => {
  ...
  const mobileNavigationLinks: NavigationLink[] = [
    ...
    { href: "/Genre", label: "Latest Release" },
  ];
              ...
              <form onSubmit={handleSearch}>
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white bg-opacity-90 backdrop-blur-sm pl-4 pr-10 py-3 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:bg-white transition-all duration-300 shadow-lg"
                    value={searchQuery}
                    onChange={handleInputChange}
                    onKeyPress={handleKeyPress}
                  />
